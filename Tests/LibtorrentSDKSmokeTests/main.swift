    ...
    struct LibtorrentSDKSmokeTests {
        ...
        private static func testNativeSessionDispatchesProgressFromNativeABI() async throws {
            ...
            case let .progress(progress):
                ...
                try require(progress.swarmDiagnostics?.connectionCount == 3, "Progress event should decode aggregate connection counts.")
